...
//        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CustomView2);
//        number = array.getInteger(R.styleable.CustomView2_numbers, 5);
//        sweepAngle = 360 / number;
//        areaColor = array.getColor(R.styleable.CustomView2_areaColor, 0x0c1f35);
//        areaClickColor = array.getColor(R.styleable.CustomView2_areaClickColor, 0x04937f);
//        centreColor = array.getColor(R.styleable.CustomView2_centreColor, 0x7f1aa7);
//        centreClickColor = array.getColor(R.styleable.CustomView2_centreClickColor, 0xffffff);
        init();
    }
